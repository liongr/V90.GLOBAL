...
;	@LPRINTCHR	"\",lpt_number,cs:print_stack5
;	@LPRINTCHR	23,lpt_number,cs:print_stack5
...
;	@LPRINTCHR	27,lpt_number,cs:print_stack5
;	@LPRINTCHR	"\",lpt_number,cs:print_stack5
;	@LPRINTCHR	21,lpt_number,cs:print_stack5
;	@LPRINTCHR	0,lpt_number,cs:print_stack5
	@LPRINTCHR	prchar_plr,lpt_number,cs:print_stack5


	mov	cx,4
denm12:	call	far ptr make_orizontia_riumisi_printer
	@LPRINTCHR	" ",lpt_number,cs:print_stack5
	loop	denm12
;	@LPRINTCHR	" ",lpt_number,cs:print_stack5
;	@LPRINTCHR	" ",lpt_number,cs:print_stack5
...
;	@LPRINTCHR	0,lpt_number,cs:print_stack5
	...
	mov	cx,12
denm0:	@LPRINTCHR	" ",lpt_number,cs:print_stack5
	loop	denm0
